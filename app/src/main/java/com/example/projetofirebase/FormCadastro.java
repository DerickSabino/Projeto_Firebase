...
public class FormCadastro extends AppCompatActivity {
    ...
    private void CadastrarUsuario(View view){
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email,senha).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            @Override                    // Task é responsavel pelo cadastro e autenticação do usuario
    ...
    private void SalvarDadosUsuario(){
        ...
        // Referência ao documento no Firestore usando o ID do usuário
        DocumentReference documentoReference = db.collection("Usuarios").document(usuarioID);

        // Definindo os dados do usuário no documento referenciado
